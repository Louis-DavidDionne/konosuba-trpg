...
Hooks.once('init', async function() {
  ...
  CONFIG.Combat.initiative = {
    formula: "@abilities.agility.checkBonus + @abilities.perception.checkBonus",
    decimals: 2
  };
  ...
  Actors.registerSheet("konosuba", KonosubaActorSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.konosuba.rollItemMacro("${item.name}");`;
